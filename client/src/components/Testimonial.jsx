    ...
    return (
      <div className="bg-white p-4 sm:p-10">
        <div className="text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-500">Testimonials</h2>
          <p className="text-base sm:text-lg text-gray-500 mt-5">Customer's Review</p>
        </div>
        <div className="flex flex-col sm:flex-row justify-center space-y-6 sm:space-y-0 sm:space-x-6 mt-8">
          <div className="flex flex-col items-center">
            <img
              alt="Henrietta Jazz"
              className="w-30 h-30 sm:w-36 sm:h-36 rounded-full"
              height="96"
            ...
            <blockquote className="mt-4 text-center text-gray-600">
              "Working with Habricks has been an absolute pleasure, From first contact to closing, the level of dedication shown to help me find the perfect property was remarkable."
            </blockquote>
