  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <input
        ...
        <input type='text' placeholder='username' defaultValue={currentUser.username} className='border p-3 rounded-lg'onChange={handleChange} />
      ...
      <div className='flex mt-5 justify-between'>
        <span onClick={handleDeleteUser} className='text-rose-500 cursor-pointer'>Delete Account</span>
        <span onClick={handleSignOut} className='text-rose-500 cursor-pointer'>Log Out</span>
      </div>
